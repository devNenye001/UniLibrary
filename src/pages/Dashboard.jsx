      ...
      <main className="mx-auto max-w-7xl px-6 py-10">
        <section className="grid gap-6 rounded-[2rem] bg-[linear-gradient(135deg,#0d1c30_0%,#173456_60%,#234876_100%)] px-8 py-10 text-white shadow-[0_30px_80px_rgba(15,23,42,0.18)] md:grid-cols-[1.2fr_0.8fr]">
          ...
          <div className="grid gap-4 sm:grid-cols-3 md:grid-cols-1">
            {stats.map((stat) => (
              <div key={stat.label} className="rounded-[1.5rem] border border-white/10 bg-white/10 p-5 backdrop-blur">
              ...
              <div className="mt-6 grid gap-4">
                {loading ? (
                  ...
                  recommendations.map((item) => (
                    <div key={item.id} className="rounded-[1.5rem] bg-campus-50 p-5">
                      <p className="text-xs font-semibold uppercase tracking-[0.25em] text-campus-600">
                        {item.courseCode}
                      </p>
